...
```{r label = "frequentistTaylorPlot",fig.height= 3.5, fig.width= 5 ,echo = F, eval = T, warning=F}
...
```{r, label = 'Plot of post dist. of psi', echo=FALSE, warning=FALSE, message=FALSE, fig.width=5, fig.height=3.5}
