...
In this case, from Table 1, there were $n = 170$ and observe $v = 8$. In our lectures, we proved that the MLE of a binomial distribution is the number of successes to the number of trials (Grove, 2026, Lecture 11). Hence,  
...
$$
P(\Psi \leq 0.3|V=v_{obs}) = 2.959 \cdot10^{-17}
$$
