...
This true probability has been calculated in terms of two other probabilities, $\pi_{v0}$ and $\pi_{p0}$, which are the proportions of COVID infections, for the vaccine and placebo groups respectively, and since the populations of those given the vaccine and those given the placebo are approximately equal, we have
...
We see the second-order Taylor approximation is accurate, mostly aligned with the log-likelihood. Thus, we move forward with the large sample confidence interval. To do so, we use theorem 12.1 (Grove, 2026, Lecture 12) to calculate our observed Fisher Information:
...
Grove, R. (2026). *Chapter 12: Likelihood Inference*. Lecture 12, Slide 3, STAT 342, University of Washington - Seattle.
